namespace Core
{
    ...
    public class UnitOfWork : IUnitOfWork, IDisposable
    {
        ...
        private const string ConnectionString =
            "Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=StudentExerciseElliot;Data Source=HS-SQL2016-01\\OCEANO";
        ...
        private static ISessionFactory CreateSessionFactory()
        {
            return Fluently.Configure()
                ...
                .Mappings(m => m.FluentMappings.AddFromAssemblyOf<AppointmentDurationClassMap>())
                .BuildSessionFactory();
        }
