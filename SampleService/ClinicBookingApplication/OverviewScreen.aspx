...
<ItemStyle Width="150px"></ItemStyle>
    ...
    <asp:DropDownList ID="PatientDropDownList" runat="server" Height="45px" Width="127px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
        ...
        <asp:TextBox ID="DateTimeTextBox" runat="server" BackColor="White" BorderColor="Black" BorderStyle="Double" OnTextChanged="TextBox1_TextChanged1">yyyy-MM-dd HH:mm</asp:TextBox>
        ...
        <asp:Button ID="NewAppointmentButton" runat="server" Height="34px" OnClick="SearchByTagButton_Click" Text="Button" />
